...
let a_aGoal = require('./a_aGoal.js');
...
class a_aActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = a_aGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new a_aActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = a_aGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new a_aGoal()
    }
