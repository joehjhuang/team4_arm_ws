...
let a_aFeedback = require('./a_aFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class a_aActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = a_aFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new a_aActionFeedback(null);
    ...
    data.feedback = a_aFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new a_aActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = a_aFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new a_aFeedback()
    }
...
module.exports = a_aActionFeedback;
