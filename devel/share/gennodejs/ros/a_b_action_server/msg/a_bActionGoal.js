...
let a_bGoal = require('./a_bGoal.js');
...
class a_bActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = a_bGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new a_bActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = a_bGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new a_bGoal()
    }
