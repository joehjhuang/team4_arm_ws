...
let a_bFeedback = require('./a_bFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class a_bActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = a_bFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new a_bActionFeedback(null);
    ...
    data.feedback = a_bFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new a_bActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = a_bFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new a_bFeedback()
    }
...
module.exports = a_bActionFeedback;
