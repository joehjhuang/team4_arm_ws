...
let a_haltFeedback = require('./a_haltFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class a_haltActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new a_haltFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = a_haltFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new a_haltActionFeedback(null);
    ...
    data.feedback = a_haltFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new a_haltActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = a_haltFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new a_haltFeedback()
    }
...
module.exports = a_haltActionFeedback;
