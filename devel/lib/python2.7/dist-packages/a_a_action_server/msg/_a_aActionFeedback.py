...
"""autogenerated by genpy from a_a_action_server/a_aActionFeedback.msg. Do not edit."""
import sys
...
class a_aActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "a_a_action_server/a_aActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','a_a_action_server/a_aFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(a_aActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = a_a_action_server.msg.a_aFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = a_a_action_server.msg.a_aFeedback()
