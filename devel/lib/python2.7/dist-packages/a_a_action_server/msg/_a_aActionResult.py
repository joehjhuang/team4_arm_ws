...
"""autogenerated by genpy from a_a_action_server/a_aActionResult.msg. Do not edit."""
import sys
...
class a_aActionResult(genpy.Message):
  _md5sum = "5999beb2a8e2166f43b18f38c5e80695"
  _type = "a_a_action_server/a_aActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','a_a_action_server/a_aResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(a_aActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = a_a_action_server.msg.a_aResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = a_a_action_server.msg.a_aResult()
