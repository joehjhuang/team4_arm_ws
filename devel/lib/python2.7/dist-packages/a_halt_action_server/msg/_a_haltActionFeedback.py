...
"""autogenerated by genpy from a_halt_action_server/a_haltActionFeedback.msg. Do not edit."""
import sys
...
class a_haltActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "a_halt_action_server/a_haltActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','a_halt_action_server/a_haltFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(a_haltActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = a_halt_action_server.msg.a_haltFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = a_halt_action_server.msg.a_haltFeedback()
