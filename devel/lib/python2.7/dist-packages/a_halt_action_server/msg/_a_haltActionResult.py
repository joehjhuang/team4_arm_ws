...
"""autogenerated by genpy from a_halt_action_server/a_haltActionResult.msg. Do not edit."""
import sys
...
class a_haltActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "a_halt_action_server/a_haltActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','a_halt_action_server/a_haltResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(a_haltActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = a_halt_action_server.msg.a_haltResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = a_halt_action_server.msg.a_haltResult()
